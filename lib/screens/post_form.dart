...
class _PostFormState extends State<PostForm> {
  ...
  void _createPost() async {
    ...
    ApiResponse response = await createPost(
        _txtControllerBody.text, _txtControllerCategory.text, image);
              ...
              children: [
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    //maxLines: 9,
                    validator: (val) =>
                        val!.isEmpty ? 'Post category is required' : null,
                    decoration: const InputDecoration(
                        hintText:
                            "  كلات للفطار اكلات للعشاء اكلات للغداء حلويات اكلات اطفالاخري",
                        border: OutlineInputBorder(
                            borderSide:
                                BorderSide(width: 1, color: Colors.black38))),
                  ),
